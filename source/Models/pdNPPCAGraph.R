...
###PrefDiv -> StEPS
pdNPPCAGraph_wrapper = function(x_tr,y_tr)
{
  nc = ncol(x_tr)
  ...
  cmd = paste("java -jar -Xmx4g PrefDiv.jar -t y -data temp2.txt -ctype pca -outData data_summary.txt -outCluster clusters.txt -outGraph graph.txt -useCausalGraph -numSelect ",graphSelect," -disc -name ",runName,sep="")
  system(cmd)
