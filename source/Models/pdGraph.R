pdGraph_wrapper = function(x_tr,y_tr)
{
  ...
  cmd = paste("java -jar -Xmx4g PrefDiv.jar -t y -data temp.txt -outData data_summary.txt -outCluster clusters.txt -outGraph graph.txt -useCausalGraph -numSelect 100 -priors tempPriors -disc -name ",runName,sep="")
  system(cmd)
