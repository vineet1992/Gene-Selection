...
pdNPPCA_wrapper = function(x_tr,y_tr)
{
  nc = ncol(x_tr)
  ...
  cmd = paste("java -jar -Xmx4g PrefDiv.jar -t y -data temp.txt -outData data_summary.txt -outCluster clusters.txt -cv 3 1,3,5,10 -ctype pca -disc -name ",runName,sep="")
  system(cmd)
